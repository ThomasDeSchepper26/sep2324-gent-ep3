...
# OLOD: SEP
# -------------------------------------------------------------------------------------------------
# The following script will build the VMs used for the Windows server and the Windows client for the 'basic' part of the excercise
# The script will make use of a name check to delete and rebuild the VMs, NIC will be placed into bridged mode for the VMs by default
# -------------------------------------------------------------------------------------------------

# Setting Alias for VBoxManage 
