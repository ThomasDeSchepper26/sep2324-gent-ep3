...
if [ -d "/home/vagrant/nginx-1.21.4/src/http/modules/headers-more-nginx-module-0.37" ]; then
    sudo rm -rf /home/vagrant/nginx-1.21.4/src/http/modules/headers-more-nginx-module-0.37
fi
mv headers-more-nginx-module-0.37 /home/vagrant/nginx-1.21.4/src/http/modules/
./configure --prefix=/etc/nginx --add-module=/home/vagrant/nginx-1.21.4/src/http/modules/headers-more-nginx-module-0.37 --with-http_ssl_module --with-http_v2_module
